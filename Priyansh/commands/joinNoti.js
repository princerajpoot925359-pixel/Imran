...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
      ...
      const fs = require("fs");
      return api.sendMessage("", event.threadID, () => api.sendMessage({body: `(Lo mai aa gyi aapki flak khan ab jaldi se swagt karo hmara😀👈\n●============================================●\n\or jaldi se mere pyare dost khan sahab ko reqwest bhej do😌👈\n●============================================●\nhttps://m.facebook.com/profile.php?id=61579619590022\n●============================================●\n\n𝗽𝗿𝗲𝗳𝗶𝘅 => 👉 ${global.config.PREFIX} 👈\n●============================================●\n\nबोट अप्रूवल के लिए ${global.config.PREFIX}request लिख के Send कर दो 🙂🖐️) 
